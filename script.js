...
cellElements.forEach((cell, index) => {
    // Listen for a click for each cell
    cell.addEventListener("click", () => {
        // If clicked, place a marker at index
        placeMarker(index);
    });
});
...
// Create function for checking result of the game
...
// Add event listener
restartButton.addEventListener("click", () => { // If button clicked
